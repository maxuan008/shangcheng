module.exports = app => {
  ...
  const ServerQualification = app.devSeq.DevMysqlSeq.define('serverQualification', model, {
    paranoid: true
  })
  ServerQualification.associate = function () {

    ServerQualification.belongsTo(app.devModel.ServerOrg, { foreignKey: 'serverOrg_id' })
  }
