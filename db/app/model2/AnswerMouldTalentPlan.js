module.exports = app => {
  ...
  const AnswerMouldTalentPlan = app.devSeq.DevMysqlSeq.define('answerMouldTalentPlan', model, {
    paranoid: true
  })
  AnswerMouldTalentPlan.associate = function () {
    AnswerMouldTalentPlan.belongsTo(app.devModel.AnswerMould, { foreignKey: 'answerMould_id' })
    AnswerMouldTalentPlan.belongsTo(app.devModel.ConfTalentPlan, { foreignKey: 'confTalentPlan_id' })
