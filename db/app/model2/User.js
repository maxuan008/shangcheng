module.exports=app=>{
  ...
  const User = app.devSeq.DevMysqlSeq.define('user', model, {
    paranoid: true
  })
  User.associate = function() {
    User.belongsTo(app.devModel.Park,{foreignKey: 'park_id'})
    User.belongsTo(app.devModel.Role,{foreignKey:'role_id'})
