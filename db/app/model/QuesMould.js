module.exports = app => {
	...
	const model = {
		...
		//年份
		year: { type: INTEGER(2), defaultValue: 1 },

		// 填报单位
		companyName: { type: INTEGER(2), defaultValue: 1 },
		...
		//==基本信息
		// 技术领域
		confFieldOfTechnology_id: { type: INTEGER(3), defaultValue: 0 },
	...
	const QuesMould = app.model.define('quesMould', model, {
		paranoid: true
	})
	QuesMould.associate = function() {
		QuesMould.belongsTo(app.pgModel.Park, { foreignKey: 'park_id' })
		QuesMould.hasMany(app.pgModel.QuesMouldConfQualification, { foreignKey: 'quesMould_id' })
		QuesMould.hasMany(app.pgModel.QuesMouldConfTalentPlan, { foreignKey: 'quesMould_id' })
		QuesMould.belongsToMany(app.pgModel.ConfQualification, {
			through: 'quesMouldConfQualification',
			foreignKey: 'quesMould_id'
		})
		QuesMould.belongsToMany(app.pgModel.ConfTalentPlan, {
			through: 'quesMouldConfTalentPlan',
			foreignKey: 'quesMould_id'
		})
