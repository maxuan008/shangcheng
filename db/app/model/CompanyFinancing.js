module.exports = app => {
    ...
    const model = {
        ...
        //新加字段
        typeOfInvestmentAndFinancing: INTEGER(2), //投融资类型
    ...
    const CompanyFinancing = app.model.define('companyFinancing', model, {
        paranoid: true
    })
    CompanyFinancing.associate = function() {
        CompanyFinancing.belongsTo(app.pgModel.Company, { foreignKey: 'company_id' })
