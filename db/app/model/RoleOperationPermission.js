module.exports=app=>{
  ...
  const RoleOperationPermission = app.model.define('roleOperationPermission', model, {
    paranoid: true
  })
  RoleOperationPermission.associate = function() {
   
    RoleOperationPermission.belongsTo(app.pgModel.OperationPermission,{foreignKey:'operationP_id'})
  }
